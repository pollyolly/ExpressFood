...
const SignUpScreen = ({navigation}) => {
    ...
    const initialValues = {phone_number:'',name:'',family_name:'',email:'',password:''}
            ...
            <Formik
                ...
                (props)=>(
                    <View style = {styles.view2}>
                        <View>
                            <Text style = {styles.text2}>New on ExpressFood</Text>
                        </View>
                        ...
                        <View style = {styles.view14}>
                            ...
                            />
                                <Animatable.View  animation = {passwordBlured?"fadeInLeft":"fadeInRight"} duration ={400}>
                                       <Icon name ="visibility-off" color ={colors.grey3} style ={{marginRight:10}}/>
                                </Animatable.View> 
                        </View>
            ...
            <View style = {styles.view18}>
                ...
                <View style ={styles.view19}>
                    <View style ={styles.view20}>
                        <Text style ={styles.text3}>Already have an account with XpressFood ?</Text>
                    </View>
